...
<body class="bg-secondary">
    <div class="container mt-5">
        <div class="row justify-content-center">
            <h1 class="text-center text-white">Configuración de Datos Personales</h1>
            <form id="user-settings-form" class="form col-md-6 bg-light shadow rounded mt-3" method="POST">
                <div class="mb-3 mt-3">
        ...
        <?php if ($cargo === "Director") { ?>
            <div class="container mt-4">
                <h2 class="text-center text-white">Solicitudes de Usuario</h2>
                <table class="table">
                    <thead>
                        <tr>
                            <th>#</th>
